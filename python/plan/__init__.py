...
extract_slug_from_draft = _mod.extract_slug_from_draft
find_draft = _mod.find_draft
find_latest_draft = _mod.find_latest_draft
find_draft_appendix = _mod.find_draft_appendix
read_current_draft = _mod.read_current_draft
write_current_draft = _mod.write_current_draft
remove_current_draft = _mod.remove_current_draft
